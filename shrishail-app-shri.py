...
while True:
    user = api.get_user('Shrisha47289305')
    print(user)
    api.update_profile(name=f'SHRISHAIL|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : SHRISHAIL|{follower_count(user)} Followers')
